...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    private function getUrl(){
        ...
        $basePath = Yii::getPathOfAlias('application.data.upload'). DIRECTORY_SEPARATOR;
        $baseUrl = Yii::app()->getController()->createUrl('ueditor.view'). '/';

        return str_replace($basePath, $baseUrl, $this->fullName);
    }
    ...
    {
        $pathStr = Yii::getPathOfAlias('application.data.upload'). DIRECTORY_SEPARATOR. $this->config[ "savePath" ];
        if ( strrchr( $pathStr , "/" ) != "/" ) {
            $pathStr .= "/";
        }
        $pathStr .= date( "Ymd" );
