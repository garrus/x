...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //涂鸦图片配置区
        ,scrawlUrl:URL+"scrawlUp.php"           //涂鸦上传地址
        ,scrawlPath:URL                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"fileUp.php"               //附件上传提交地址
        ,filePath:URL                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"getRemoteImage.php"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:URL + "imageManager.php"       //图片在线管理的处理地址
        ,imageManagerPath:URL                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: location.hostname                                 //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: URL +"imageUp.php" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: URL
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:URL + "imageUp.php"             //word转存提交地址
        ,wordImagePath:URL                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //视频上传配置区
        ,getMovieUrl:URL+"getMovie.php"                   //视频数据获取地址
        ,videoUrl:URL+"fileUp.php"               //附件上传提交地址
